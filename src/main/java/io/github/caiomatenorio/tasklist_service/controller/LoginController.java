...
public class LoginController {
    ...
    @PostMapping
    public ResponseEntity<ConventionalResponse> login(@Valid @RequestBody LoginRequest request)
        ...
        return new SuccessResponse<>(200, "Login successful").toResponseEntity(headers);
    }
}
